...
Router.prototype.api = function(){
  ...
  var classes = new express.Router();
  ...
  classes.post("/join", (req, res) => {
    ...
    utils.isLogged(sessionid)
      .then(success => {
        ...
        return utils.exists(userid);

      })

      .then(success => {

        return c.addUserToClass(userid, key);
  ...
  classes.get("/members/:classurl", (req, res) => {

    var url = req.params.classurl;
    // no sessionid needed, classes' users are public
  ...
  classes.post("/getClasses", (req, res) => {
  ...
  classes.post("/add", (req, res) => {
    ...
    utils.isLogged(sessionid)
      ...
      .then(success => {
        ...
        return c.addClass(author, classname);
